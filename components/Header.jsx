...
import { BsFillTelephoneFill, BsFillEnvelopeFill, BsFillGrid3X3GapFill, BsSearch, BsFacebook, BsTwitter, BsLinkedin, BsYoutube, BsPinterest, BsFillPersonFill } from "react-icons/bs";
        ...
        <div className='container w-[100%]'>
            <div className='flex-wrap justify-between flex box-border'>
                ...
                <div className='xl:col-span-4 lg:col-span-6 md:col-span-12'>
                    ...
                    <button className='ml-10 border-l-white pl-5 text-[14px] flex flex-row'>
                        <span className=' mr-2 items-center flex'>
    ...
    <div className='w-[100%] container px-3 mx-auto'>
        <div className='flex items-center justify-between'>
            <div className='w-[10%] mr-5'>
                <img src={logo} className='max-w-[50%] h-auto align-middle' alt='/' />
            </div>
            <div className='block'>
                <ul>
                    <li className='relative '>
                        <button className='text-[16px] flex flex-row font-semibold leading-6 capitalize'
                        onClick={() => setMenu(!menu)}>
                        <span className='mr-1 items-center flex mt-1'>
                             <BsFillGrid3X3GapFill style={{ color: '#000850' }}/>
                        </span>
                        <h1 className='text-[16px] leading-7 font-semibold ml-2'>Categories</h1>
                        </button>
                        <ul className={!menu ? 'hidden' : ' text-[#000850] border-[1px] absolute ml-0 mt-5 min-w-[250px] rounded-lg transition-all ease-out z-50 h-auto shadow-md bg-white py-3 px-1'}>
            ...
            <div className='relative block ml-6 box-border'>
                <form className='flex flex-row box-border'>
                    <input className='border-solid border-[#000850] py-2 px-5 rounded-md w-56 h-14 bg-[#f5f5f5e3] transition-all ease-in-out block font-normal text-[#212529] m-0' type='text' placeholder='Search for Course' />
        ...
        <div className='items-center justify-center grid gap-x-6 gap-y-0 lg:grid-cols-2  md:grid-cols-1'>
            <div className='basis-1/2 md:basis-[100%] flex'>
                <div>
                    ...
                    <h1 className='text-[48px] font-bold leading-[62px] my-5 text-white'>Upgrade your learning Skills & Upgrade your life</h1>
                    <p className='mb-10 text-[18px] leading-8 text-white opacity-75'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores ullam libero magni reiciendis quam ipsa blanditiis, facilis velit eaque illo?</p>
                    <div className='flex flex-row'>
                        <button className='bg-red-500 text-white hover:scale-110 mr-4 font-semibold relative capitalize py-3 px-7 text-[16px] rounded-md align-middle'>Find Courses</button>
                        <button className='bg-white text-red-500 hover:scale-110 font-semibold relative capitalize py-3 px-7 text-[16px] rounded-md align-middle'>Get Started</button>
                    </div>
                </div>
            </div>
            <div className='flex basis-1/2 md:basis-[100%]'>
                <img className='mt-0 pl-12 box-border w-[100%] h-auto' src={banner} alt='/' />
            </div>
        </div>
    </div>
</div>
