        ...
        <div className="container w-[100%] mx-auto">
          ...
          <div className="grid grid-cols-4 justify-center gap-6">
            <div className="w-auto p-10 text-center hover:scale-110 hover:bg-blue-100 rounded-xl shadow-xl">
              <img
                src={team}
                className="mb-5 w-full h-auto bg-cover rounded-full flex justify-center"
                alt="/"
              />
              <div className="overflow-hidden text-center">
                <h4 className="mb-2 text-[22px] font-semibold ">Haris Ham</h4>
                <p className="text-[16px] text-[#5081c7]">SEO Expert</p>
              </div>
            </div>
